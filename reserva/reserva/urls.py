...
urlpatterns = [
    ...
    path('', (MostrarPost.as_view()), name='index'),
    ...
    path('usuarios/login/', views.LoginView.as_view(template_name='usuarios/login.html'), name='login'),
    path('usuarios/logout/', views.LogoutView.as_view(template_name='usuarios/logout.html'), name='logout'),
